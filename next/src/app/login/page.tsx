      ...
      <div className="auth">
        ...
        <div className="card">
          ...
          <form onSubmit={submit}>
            ...
            {notice && <p style={{ color: 'var(--spruce-ink)', fontSize: 14, marginBottom: 0 }}>{notice}</p>}
        ...
        <p className="muted" style={{ textAlign: 'center', fontSize: 14 }}>
          ...
          <a href="#" onClick={(e) => { e.preventDefault(); setMode(mode === 'login' ? 'signup' : 'login'); setError(null); setNotice(null) }}>
